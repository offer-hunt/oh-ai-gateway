package ru.offer.hunt.oh_ai_gateway.security;
...
class SecurityTest {
    ...
    void ok200() throws Exception {
        String token =
                JwtTestUtil.rs256Token(rsaKey, issuer, audience, List.of("USER"), List.of("ai-gateway.read"));
